# ef-shops
A React shop frontend for Qbox, ox_inventory, and economyreworked.
...
# Features
- Client-side purchase validation (cash/bank/weight/shared stock) + server-side security checks
- Business products, prices, ownership, and stock managed by economyreworked
